 ...
 * @author Lxgxgxgxg
 * @version 1.0.0
 * @ClassName RangeProof.java
 * @Description TODO
 * @createTime 2021年11月08日 18:14:00
 */
...
//        }
        ...
        BigInteger[] yVector = GetValueN.getValueN(y, g, arr);
//        display(yVector);
...
//        display(left);
        BigInteger[] twoN = GetValueN.getValueN(BigInteger.valueOf(2), g, arr);
